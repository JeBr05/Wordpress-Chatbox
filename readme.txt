=== Jeroen's Chatbox ===
Contributors: jeroen
Tags: chatbox, ai, openai, support, knowledge base
...
Jeroen's Chatbox gives site owners a dashboard to select content, add metadata, sync content to an OpenAI vector store and publish a chatbox with a shortcode or site wide auto embed.
